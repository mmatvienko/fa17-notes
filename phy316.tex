...
\newcommand{\calE}{{\!\!\text{\usefont{U}{calligra}{m}{n}E}\,\,}}
   ...
   \section{Resistors in Series and Parallel}
    ...
    $$\Phi = BA = Blx$$
    Farady: $\calE =\frac{d\Phi}{dt} = -\frac{d}{d t}Blx = Bl \frac{dx}{dt} = -lv$. If loop sis clsed, current flows. $I = \frac{\calE}{R} = -\frac{Blv}{R}$. 
    Energy designated: $P = I^2R = \frac{B^2l^2v^2}{R}$. Another view: $\vec{F} = I\vec{l} \times \vec{B} = I;B = \frac{Blv}{R}lB$
    Hence we can say $P = Fv = \frac{B^2l^2v^2}{R}$
